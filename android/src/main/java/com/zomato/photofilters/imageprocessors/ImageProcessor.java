...
public final class ImageProcessor {
    ...
    public static Bitmap applyCurves(Integer[] rgb, Integer[] red, Integer[] green, Integer[] blue, Bitmap inputImage) {
        // create output bitmap
        Bitmap outputImage = inputImage;

        // get image size
        Integer width = inputImage.getWidth();
        Integer height = inputImage.getHeight();
    ...
    public static Bitmap doBrightness(Integer value, Bitmap inputImage) {
        Integer width = inputImage.getWidth();
        Integer height = inputImage.getHeight();
        Integer[] pixels = new Integer[width * height];
    ...
    public static Bitmap doColorOverlay(Integer depth, float red, float green, float blue, Bitmap inputImage) {
        Integer width = inputImage.getWidth();
        Integer height = inputImage.getHeight();
        Integer[] pixels = new Integer[width * height];
